    ...
    return (
        <div className='mt-24 container mx-auto'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-24 container mx-auto'>
                {
                    products.map(product => <label htmlFor="my-modal-3" key={product._id} className="card w-96 bg-base-100 shadow-xl cursor-pointer">
                        ...
                        <div className="card-body">
                            ...
                            <div className="modal">
                                <div className="modal-box relative">
                                    ...
                                    <p className="py-4"><span className='text-thin text-slate-400'>Details:</span> {product.description}..</p>
                                    ...
                                    <div className='w-full flex justify-end'>
                                        <button className='btn border-none bg-gradient-to-r from-blue-400 to-secondary text-white'>Book Now!</button>
                                    </div>
                                </div>
                            </div>
                        </div>
