        ...
        <div className='container mx-auto'>
            <div className="lg:flex lg:flex-row-reverse px-3 lg:h-screen lg:mb-0 lg:mt-0 rounded-xl mb-20">
                ...
                <div className='lg:w-1/2 my-auto rounded-xl'>
                    <img className='rounded-xl opacity-60' src="https://i.postimg.cc/cCZtgT0q/pexels-pixabay-159618.jpg" alt="" />
                </div>
                <div className='my-auto mr-auto'>
                    <h1 className='font-bold text-4xl lg:text-7xl lg:leading-[70px] mt-5 text-blue-900 font-serif'>Never Stop Reading</h1>
                    <h2 className='lg:my-8 my-4 text-white lg:text-xl '>A home for those who love to read books and have no problem buying old ones.</h2>
